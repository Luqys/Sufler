...
import { commandHint, commandInvocation, commandNameFromRelative } from '../../src/shared/claude/commands';
import { readSkillsSnapshot, skillsSourceDirs } from '../../src/main/skills/skills';
