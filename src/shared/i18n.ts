...
export const PL = {
  ...
  'welcome.newGitFailed': 'Folder powstał, ale bez repozytorium git — sprawdź, czy `git` jest dostępny.',
...
export const EN: Record<StringKey, string> = {
  ...
  'welcome.newGitFailed': 'The folder was created, but without a git repository — check that `git` is available.',
