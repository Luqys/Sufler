...
export const PL = {
  ...
  'dock.scrollTop': 'Na początek sesji',
  'dock.scrollBottom': 'Na koniec sesji',
  'dock.search': 'Szukaj w sesji (Cmd+F)',
  'terminal.searchPlaceholder': 'Szukaj w sesji…',
  'terminal.searchCount': '{index} z {total}',
  'terminal.searchNone': 'brak trafień',
  'terminal.searchPrev': 'Poprzednie trafienie (Shift+Enter)',
  'terminal.searchNext': 'Następne trafienie (Enter)',
