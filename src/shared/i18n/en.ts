...
export const EN: Record<StringKey, string> = {
  ...
  'dock.scrollTop': 'Jump to the start of the session',
  'dock.scrollBottom': 'Jump to the end of the session',
  'dock.search': 'Search in the session (Cmd+F)',
  'terminal.searchPlaceholder': 'Search in the session…',
  'terminal.searchCount': '{index} of {total}',
  'terminal.searchNone': 'no matches',
  'terminal.searchPrev': 'Previous match (Shift+Enter)',
  'terminal.searchNext': 'Next match (Enter)',
  ...
  'git.tab.changes': 'Working changes',
  'git.tab.history': 'Commit history',
  'git.tab.points': 'Checkpoints and worktrees',
  'git.noChanges': 'No working changes — the tree is clean.',
  ...
  'mcp.source': 'Source: project configuration + `claude mcp list`',
  'mcp.addShort': '+ Server',
  'mcp.refreshShort': 'Refresh',
  'mcp.detailState': 'State',
  'mcp.detailTarget': 'Address',
  ...
  'skills.newRuleShort': '+ Rule',
  'skills.delete': 'Delete skill',
  'skills.deleteTitle': 'Delete this skill?',
  'skills.deleteMessage': 'Skill “{name}” will be removed together with its whole directory:\n{path}',
  'skills.deleted': 'Skill “{name}” deleted.',
  'skills.deleteFailed': 'Could not delete the skill.',
  'skills.toggleTitle':
  ...
  'unit.minShort': 'min',
  'unit.hourShort': 'h',
  'sessions.inConversations': 'In conversations',
  'sessions.searching': 'Searching transcripts…',
  'sessions.noHits': 'That phrase is not in any conversation.',
  'sessions.moreHits': '+{count} more hits in this conversation',
  'sessions.hitsNote': 'click to expand the conversation',
  ...
  'sessions.noMatch': 'No session has that phrase in its title or branch.',
  ...
  'worktree.mainBadge': 'project',
  'worktree.new': 'Create',
  'worktree.newHint': 'New working directory with its own branch (git worktree add)',
  'worktree.namePlaceholder': 'branch name…',
  'worktree.created': 'Worktree “{name}” ready — a Claude session starts in it.',
  'worktree.exists': 'That branch or directory already exists.',
  'worktree.createFailed': 'Could not create the worktree.',
  'worktree.session': 'Open a Claude session in this directory',
  'worktree.diff': 'Show what this worktree adds over the project branch',
  'worktree.diffLoading': 'Computing the difference…',
  'worktree.diffUnavailable': 'Cannot compare with the base branch.',
  'worktree.diffEmpty': 'This branch adds no changes yet.',
  'worktree.merge': 'Merge this branch into the current one (merge --no-ff)',
  'worktree.mergeShort': 'Merge',
  'worktree.mergeTitle': 'Merge the branch?',
  'worktree.mergeMessage': 'Branch “{branch}” will be merged into the current project branch.',
  'worktree.merged': 'Merged “{branch}” into “{into}”.',
  'worktree.conflict': 'Conflict merging “{branch}” — the merge was aborted, resolve it in a terminal.',
  'worktree.mergeFailed': 'Could not merge the branch.',
  'worktree.remove': 'Remove the worktree directory',
  'worktree.removeTitle': 'Remove the worktree?',
